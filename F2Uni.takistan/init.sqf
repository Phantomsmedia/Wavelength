...
// ====================================================================================
// HC HANDLING, DISABLED UNTIL BETA PATCH 1.63 APPROVED.
//
//if (HeadlessClient == 1) then { //All handles the HC client and whether it runs or not.
//	if (isServer) then {
//		HCPresent = true;
...
["Welcome to a PhanTactical","mission-have a good game!"] call BIS_fnc_infoText;
sleep 2;		
        ["***Mission Name Here***"] call BIS_fnc_infoText;
