// F2 - Folk Assign Gear Script - PMC Equipment (Edited by Batboyx2 for Phantactical @ www.phantactical.com)
...
_ruckSack = "ACE_VTAC_RUSH72";
_radioRuckSack = "ACE_PRC119_MAR";
_medicRuckSack = "ACE_VTAC_RUSH72";

_rifle = "M4A3_CCO_EP1"; _riflemag = "30Rnd_556x45_Stanag";																						// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)
...
_glrifle = "m8_carbineGL"; _glriflemag = "30Rnd_556x45_Stanag"; _glmag = "1Rnd_HE_M203";														// Rifle with GL and HE grenades (CO, DC, FTLs)
...
_pistol = "ACE_P226"; _pistolmag = "ACE_15Rnd_9x19_P226";																								// Pistols (CO, DC, Automatic Rifleman, Medium MG Gunner)
...
_AR = "m8_SAW"; _ARmag = "100Rnd_556x45_BetaCMag";																							// Automatic Rifleman
...
_SNrifle = "SCAR_H_LNG_Sniper"; _SNriflemag = "20Rnd_762x51_B_SCAR";																					// Sniper
