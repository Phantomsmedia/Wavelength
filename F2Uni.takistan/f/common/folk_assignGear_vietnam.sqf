...
_rifle = "M16A2"; _riflemag = "20Rnd_556x45_Stanag";																						// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)
...
_baglarge =  "ACE_Coyote_Pack_Wood"; 		// 12+ slots
...
_MAT = "ACE_M72A2"; _MATmag1 = "ACE_M72A2"; _MATmag2 = "ACE_M72A2";																			// Medium AT

_HAT = "ACE_M72A2"; _HATmag1 = "ACE_M72A2"; _HATmag2 = "ACE_M72A2";																				// Heavy AT Gunner
...
_SNrifle = "ACE_m16a2_scope"; _SNriflemag = "ACE_30Rnd_556x45_SB_Stanag";																					// Sniper
