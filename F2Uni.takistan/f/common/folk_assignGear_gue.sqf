...
_ruckSack = "ACE_BackPack_Olive";
_radioRuckSack = "ACE_PRC119";
_medicRuckSack = "ACE_BackPack_Olive";

_rifle = "ACE_AKM"; _riflemag = "30Rnd_762x39_AK47";																						// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)

_carbine = "ACE_AKM"; _carbinemag = "30Rnd_762x39_AK47"; 																					// Standard Carabineer (Medic, HMG Gunner, Rifleman (AT), Rifleman (AA), MAT Gunner, HAT Gunner, MTR Gunner, Carabineer)
...
_glrifle = "ACE_AKM_GL"; _glriflemag = "30Rnd_762x39_AK47"; _glmag = "1Rnd_HE_GP25";														// Rifle with GL and HE grenades (CO, DC, FTLs)
