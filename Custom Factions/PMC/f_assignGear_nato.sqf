...
// Vests
_lightRig = ["V_TacVest_blk","V_TacVest_oli","V_TacVest_brn"]; 
_mediumRig = ["V_TacVestIR_blk"]; 	// default for all infantry classes
...
_ghillieHelmet = ["H_Booniehat_khk","H_Booniehat_oli"];
_ghillieRig = ["V_TacVestIR_blk"]; 
_ghillieGlasses = [];
