...
_baseHelmet = ["rhs_6b27m_digi_ess","rhs_6b27m_ess"];
_baseGlasses = [];

// Vests
lightRig = ["rhs_6b23_6sh92_radio"];
_mediumRig = ["rhs_6b23_6sh92_radio"]; 	// default for all infantry classes
_heavyRig = ["rhs_6b23_6sh92_radio"];
