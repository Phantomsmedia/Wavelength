...
//-------------------------------------------------------------------------------------------------
  ...
  case 8:
  {
    _Unit_Pool_S = ["B_G_engineer_F","rhs_g_medic_F","rhs_g_Soldier_SL_F","rhs_g_Soldier_F","rhs_g_Soldier_AR_F,,"rhs_g_Soldier_lite_F","rhs_g_Soldier_LAT_F","rhs_g_Soldier_M_F","rhs_g_Soldier_exp_F"];
