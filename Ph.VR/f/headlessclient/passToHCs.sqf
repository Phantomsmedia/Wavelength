...
while {true} do {
  ...
  _numTransfered = 0;
  {
    ...
    {if (str _x in ["blacklist1", "blacklist2", "blacklist3", "blacklist4", "blacklist5", "blacklist6", "blacklist7", "blacklist8", "blacklist9", "blacklist10"]) then {_swap = false;};} forEach (units _x);
