f_param_backpacks = 1;
// F3 - Folk Assign Gear Script - AGF
...
_glmag = "hlc_VOG25_AK";
_glrifle_attach = ["HLC_Optic_1p29"];
...
// LOADOUT: COMMANDER
	case "co":
	{
		...
		{_unit addItem _bandage} foreach [1,2,3];
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		_unit addmagazines [_fgflaregreen,2];
		_unit addmagazines [_fgflarered,2];
