// F3 - Folk ARPS Assign Gear Script - IRA
...
// Sniper
_SNrifle = "CUP_srifle_LeeEnfield";
_SNrifleMag = "CUP_10x_303_M";
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_Rebel_A","MNP_CombatUniform_Rebel_B"];
_pilotHelmet = ["rhs_gssh18"];
_pilotRig = ["V_TacVest_oli"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_Rebel_A","MNP_CombatUniform_Rebel_B"];
