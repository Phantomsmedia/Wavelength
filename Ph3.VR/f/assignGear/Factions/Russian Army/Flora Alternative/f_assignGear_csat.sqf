// F3 - Folk ARPS Assign Gear Script - Russian Army - Flora Alternative
...
_baseHelmet = ["rhs_6b26","rhs_6b26_ess"];
_baseGlasses = [];

// Armored vests
_lightRig = ["rhs_6sh92"];
_mediumRig = ["rhs_6b23_6sh92","rhs_6b23_6sh92_radio"]; 	// default for all infantry classes
_heavyRig = ["rhs_6b13_Flora"];
...
_ghillieRig = ["rhs_6b23_6sh92_headset"];
_ghillieGlasses = [];
