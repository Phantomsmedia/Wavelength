...
// Backpacks
_bagsmall = "B_FieldPack_ocamo";			// small backpack
_bagmedium = "B_TacticalPack_ocamo";		// medium backpack
...
_baseHelmet = ["H_HelmetO_ocamo","H_HelmetSpecO_ocamo","H_HelmetLeaderO_ocamo"];
_baseGlasses = [];
