// F3 - Folk ARPS Assign Gear Script - Russian Military - Mountain
...
// Armored vests
_lightRig = ["rhs_6sh92"];
_mediumRig = ["rhs_6b23_ML_6sh92_radio","rhs_6b23_ML_6sh92"]; 	// default for all infantry classes
_heavyRig = ["rhs_6b23_ML_6sh92"];
