// F3 - Folk ARPS Assign Gear Script - Private Military Contractors
...
_baseHelmet = ["rhsusf_mich_bare_alt","rhsusf_mich_bare_alt_tan","H_Cap_usblack","H_Cap_khaki_specops_UK"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_khk","V_TacVest_oli"];
_mediumRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_khk","V_TacVest_oli"]; 	// default for all infantry classes
_heavyRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_khk","V_TacVest_oli"];
...
_ghillieHelmet = ["H_Booniehat_khk_hs"];
