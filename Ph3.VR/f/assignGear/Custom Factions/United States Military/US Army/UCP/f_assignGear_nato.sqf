// F3 - Folk ARPS Assign Gear Script - United States Military - US Army - UCP
...
_mediumRig = ["rhsusf_iotv_ucp_Rifleman","rhsusf_iotv_ucp_SAW","rhsusf_iotv_ucp_Grenadier"]; 	// default for all infantry classes
