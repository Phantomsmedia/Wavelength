// F3 - Folk Assign Gear Script - Desert Rebels
...
_scope1 = "rhs_acc_pso1m2";					// ACO
_scope2 = "rhs_acc_pso1m2";					// MRCO Scope - 1x - 6x
...
_baseUniform = ["MNP_CombatUniform_Militia_DE","MNP_CombatUniform_Militia_DF","MNP_CombatUniform_Militia_DB","MNP_CombatUniform_Militia_DC","MNP_CombatUniform_Militia_DA"];
_baseHelmet = ["MNP_Boonie_Jigsaw","H_ShemagOpen_tan","H_ShemagOpen_khk","H_Cap_tan","H_Bandanna_sand"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_oli","V_TacVest_khk"];
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_Militia_DE","MNP_CombatUniform_Militia_DF","MNP_CombatUniform_Militia_DB","MNP_CombatUniform_Militia_DC","MNP_CombatUniform_Militia_DA"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["V_TacVest_oli","V_TacVest_khk"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_Militia_DE","MNP_CombatUniform_Militia_DF","MNP_CombatUniform_Militia_DB","MNP_CombatUniform_Militia_DC","MNP_CombatUniform_Militia_DA"];
_crewHelmet = ["rhs_tsh4"];
_crewRig = ["V_TacVest_oli","V_TacVest_khk"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["MNP_CombatUniform_Militia_DE","MNP_CombatUniform_Militia_DF","MNP_CombatUniform_Militia_DB","MNP_CombatUniform_Militia_DC","MNP_CombatUniform_Militia_DA"];
_ghillieHelmet = ["MNP_Boonie_Jigsaw","H_ShemagOpen_tan","H_ShemagOpen_khk","H_Cap_tan","H_Bandanna_sand"];
_ghillieRig = ["V_Chestrig_rgr","V_Chestrig_khk"];
_ghillieGlasses = [];
