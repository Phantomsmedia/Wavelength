// F3 - Folk ARPS Assign Gear Script - Chernarussian Defence Forces
...
_baseUniform = ["U_CDF_A3_uniform_ttsko"];
_baseHelmet = ["H_CDF_A3_HelmetIA"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_CDF_A3_6b23"];
_mediumRig = ["V_CDF_A3_6b23_rifleman_01","V_CDF_A3_6b23_rifleman_02"]; 	// default for all infantry classes
_heavyRig = ["V_CDF_A3_6b23_rifleman_02"];
...
// Pilot
_pilotUniform = ["U_CDF_A3_uniform_ttsko"];
_pilotHelmet = ["rhs_zsh7a_mike"];
_pilotRig = ["V_CDF_A3_6b23_crew"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_CDF_A3_uniform_ttsko"];
...
_ghillieRig = ["V_CDF_A3_6b23_crewofficer"];
_ghillieGlasses = [];
