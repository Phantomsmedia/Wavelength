// F3 - Folk Assign Gear Script - Democratic Federation of Panthera Armed Forces
...
_baseUniform = ["MNP_CombatUniform_Australia_S"];
_baseHelmet = ["MNP_Helmet_PAGST_OD","MNP_MC_OD"];
_baseGlasses = [];

// Armored vests
_lightRig = ["rhs_vydra_3m"];
_mediumRig = ["MNP_Vest_OD_B","MNP_Vest_OD_A"]; 	// default for all infantry classes
