// F3 - Folk ARPS Assign Gear Script - The Patriots
...
_bagmedium = "TRYK_B_Kitbag_blk";				// carries 240, weighs 30
_baglarge = "TRYK_B_Coyotebackpack_BLK"; 		// carries 320, weighs 40
...
_baseUniform = ["TRYK_SUITS_BLK_F"];
_baseHelmet = [];
_baseGlasses = ["G_Bandanna_blk"];

// Armored vests
_lightRig = ["TRYK_V_tacv1_BK"];
_mediumRig = ["TRYK_V_tacv1_BK","TRYK_V_tacv1LC_BK"]; 	// default for all infantry classes
_heavyRig = ["TRYK_V_tacv1LC_BK"];
...
// Pilot
_pilotUniform = ["TRYK_SUITS_BLK_F"];
_pilotHelmet = ["TRYK_H_TACEARMUFF_H"];
_pilotRig = ["TRYK_V_tacv1_BK"];
_pilotGlasses = ["G_Bandanna_blk"];

// Crewman
_crewUniform = ["TRYK_SUITS_BLK_F"];
_crewHelmet = ["TRYK_H_TACEARMUFF_H];
_crewRig = ["TRYK_V_tacv1_BK"];
_crewGlasses = ["G_Bandanna_blk"];

// Ghillie
_ghillieUniform = ["TRYK_SUITS_BLK_F"];
_ghillieHelmet = [];
_ghillieRig = ["TRYK_V_tacv1LC_BK"];
_ghillieGlasses = ["G_Bandanna_blk"];
