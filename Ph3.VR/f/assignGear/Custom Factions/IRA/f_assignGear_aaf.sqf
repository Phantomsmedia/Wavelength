// F3 - Folk Assign Gear Script - IRA
...
_scope1 = "hlc_optic_artel_m14";						// ACO
_scope2 = "hlc_optic_artel_m14";						// MRCO Scope - 1x - 6x
...
_baseUniform = ["MNP_CombatUniform_Rebel_A","MNP_CombatUniform_Rebel_B"];
_baseHelmet = [];
_baseGlasses = ["G_Balaclava_blk","G_Balaclava_oli"];

// Armored vests
_lightRig = ["V_TacVest_oli"];
_mediumRig = ["V_Chestrig_rgr","V_Chestrig_blk"]; 	// default for all infantry classes
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_Rebel_B"];
_pilotHelmet = ["H_PilotHelmetHeli_B"];
_pilotRig = ["V_TacVest_oli"];
_pilotGlasses = ["G_Balaclava_blk","G_Balaclava_oli"];

// Crewman
_crewUniform = ["MNP_CombatUniform_Rebel_A"];
_crewHelmet = ["H_HelmetCrew_I"];
_crewRig = ["V_TacVest_oli"];
_crewGlasses = ["G_Balaclava_blk","G_Balaclava_oli"];

// Ghillie
_ghillieUniform = ["MNP_CombatUniform_Rebel_B"];
_ghillieHelmet = [];
