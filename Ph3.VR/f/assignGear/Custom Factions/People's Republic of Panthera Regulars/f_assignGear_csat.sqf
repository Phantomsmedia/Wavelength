// F3 - Folk Assign Gear Script - People's Republic of Panthera Regulars
...
// ATTACHMENTS - HANDGUN
_hg_silencer1 = "muzzle_snds_acp";	// 9mm suppressor
...
_baglarge = "B_TacticalPack_oli"; 			// carries 320, weighs 40
...
_ARmag_tr = "hlc_100Rnd_762x51_B_M60E4";
...
// Woodland-Hex
_baseUniform = ["MNP_CombatUniform_NKR_Rg","MNP_CombatUniform_NKR_Sh"];
_baseHelmet = ["H_MilCap_gry","rhs_6b27m_green"];
_baseGlasses = [];

// Urban
//_baseUniform = ["MNP_CombatUniform_NKR_Rg"];
//_baseHelmet = ["MNP_MC_OD","H_Bandanna_sand", "H_Watchcap_khk"];

// Armored vests
_lightRig = ["V_Chestrig_rgr"];
_mediumRig = ["V_HarnessOGL_gry","V_HarnessO_gry"]; 	// default for all infantry classes
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_NKR_Rg"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["V_HarnessO_brn"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_NKR_Rg"];
_crewHelmet = ["H_HelmetCrew_O"];
_crewRig = ["V_HarnessO_brn"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["MNP_CombatUniform_NKR_Rg"];
_ghillieHelmet = [];
_ghillieRig = ["V_Chestrig_khk"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["MNP_CombatUniform_NKR_Rg"];
_sfhelmet = ["MNP_MC_OD","H_Bandanna_sand", "H_Watchcap_khk"];
