// F3 - Folk Assign Gear Script - NATO Virtual Reality
...
_baseUniform = ["U_B_Protagonist_VR"];
...
// Pilot
_pilotUniform = ["U_B_Protagonist_VR"];
_pilotHelmet = ["H_PilotHelmetHeli_B"];
_pilotRig = ["V_TacVest_blk"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_B_Protagonist_VR"];
_crewHelmet = ["H_HelmetCrew_B"];
_crewRig = ["V_TacVest_blk"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["U_B_Protagonist_VR"];
_ghillieHelmet = [];
_ghillieRig = ["V_PlateCarrier1_blk"];
_ghillieGlasses = [];
