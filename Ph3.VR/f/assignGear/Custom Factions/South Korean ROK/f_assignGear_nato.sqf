// F3 - Folk Assign Gear Script - South Korean ROK
...
_rifle = "hlc_rifle_vendimus";
_riflemag = "29rnd_300BLK_STANAG";
_riflemag_tr = "29rnd_300BLK_STANAG_T";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "hlc_rifle_Bushmaster300";
_carbinemag = "29rnd_300BLK_STANAG";
_carbinemag_tr = "29rnd_300BLK_STANAG_T";
...
_glrifle = "hlc_rifle_vendimus";
_glriflemag = "29rnd_300BLK_STANAG";
_glriflemag_tr = "29rnd_300BLK_STANAG_T";
...
// Backpacks
_bagsmall = "MNP_B_ROK_AP";					// carries 120, weighs 20
_bagmedium = "MNP_B_ROK_KB";				// carries 240, weighs 30
_baglarge = "MNP_B_ROK_KB"; 				// carries 320, weighs 40
...
_baseUniform = ["MNP_CombatUniform_ROK_A","MNP_CombatUniform_ROK_B"];
_baseHelmet = ["MNP_Helmet_ROK"];
_baseGlasses = [];

// Armored vests
_lightRig = ["MNP_Vest_ROK_1"];
_mediumRig = ["MNP_Vest_ROK_1"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_ROK_2"];
