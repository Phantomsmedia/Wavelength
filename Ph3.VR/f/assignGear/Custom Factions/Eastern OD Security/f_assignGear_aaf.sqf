// F3 - Folk Assign Gear Script - Eastern OD Security
...
_baseHelmet = ["MNP_Helmet_OD","MNP_MC_OD"];
_baseGlasses = ["T_HoodODBLK","T_HoodOD","PU_shemagh_ODBLK"];

// Armored vests
_lightRig = ["MNP_Vest_Light_OD"];
