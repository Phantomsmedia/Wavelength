// F3 - Folk ARPS Assign Gear Script - PMC
...
_rifle = "CUP_arifle_G36A";
_riflemag = "30Rnd_556x45_Stanag";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "CUP_arifle_G36K";
...
_baseHelmet = ["rhsusf_ach_bare","rhsusf_ach_bare_ess","rhsusf_ach_bare_tan","rhsusf_ach_bare_tan_ess","H_Cap_usblack","H_Cap_khaki_specops_UK","H_Booniehat_oli","H_Booniehat_tan","H_Booniehat_khk"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_camo"];
_mediumRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_khk","V_TacVest_oli"]; 	// default for all infantry classes
...
_crewHelmet = ["H_Watchcap_khk"];
_crewRig = ["V_TacVest_camo"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_3"];
_ghillieHelmet = ["H_Booniehat_oli","H_Booniehat_tan","H_Booniehat_khk"];
_ghillieRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_khk","V_TacVest_oli"];
_ghillieGlasses = [];
