...
_scope4 = "rhs_acc_pgo7v";				// MAT Scope
...
_baseHelmet = ["rhsusf_mich_bare_alt","rhsusf_mich_bare_alt_tan","H_Cap_blk_ION"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_blk","V_TacVest_camo","V_TacVest_brn","V_TacVest_khk","V_TacVest_oli"];
_mediumRig = ["V_TacVest_blk","V_TacVest_camo","V_TacVest_brn","V_TacVest_khk","V_TacVest_oli"]; 	// default for all infantry classes
...
_ghillieHelmet = ["H_Booniehat_khk"];
