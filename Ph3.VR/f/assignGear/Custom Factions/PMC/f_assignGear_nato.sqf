...
_baseHelmet = ["rhsusf_mich_bare_alt","rhsusf_mich_bare_alt_tan","H_Cap_khaki_specops_UK","H_Cap_usblack","H_Booniehat_khk"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_BandollierB_blk","V_BandollierB_cbr","V_BandollierB_rgr","V_BandollierB_khk","V_BandollierB_oli"];
_mediumRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_camo","V_TacVest_khk","V_TacVest_oli"]; 	// default for all infantry classes
...
_ghillieHelmet = ["rhsusf_Bowman"];
_ghillieRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_camo","V_TacVest_khk","V_TacVest_oli"];
_ghillieGlasses = [];
