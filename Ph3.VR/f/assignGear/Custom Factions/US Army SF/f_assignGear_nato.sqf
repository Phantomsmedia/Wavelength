...
_silencer1 = "hlc_muzzle_556NATO_KAC";	// 5.56 suppressor
_silencer2 = "hlc_muzzle_snds_M14";	// 6.5 suppressor

_scope1 = "optic_Holosight";	// Holosight
_scope2 = "optic_Hamr";			// MRCO Scope - 1x - 6x
_scope3 = "RH_t1";			// SOS Scope - 18x - 75x
...
_glrifle = "hlc_rifle_m14sopmod";
_glriflemag = "hlc_50Rnd_762x51_B_M14";
_glriflemag_tr = "hlc_20Rnd_762x51_T_M14";
...
// Automatic Rifleman
_AR = "hlc_rifle_RU556";
_ARmag = "30Rnd_556x45_Stanag";
_ARmag_tr = "30Rnd_556x45_Stanag_Tracer_Red";
...
_baseUniform = ["MNP_CombatUniform_Ranger_A","MNP_CombatUniform_Ranger_A","MNP_CombatUniform_Ranger_A"];
_baseHelmet = ["MNP_Helmet_ACU","MNP_Boonie_ACU"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_camo","V_TacVest_oli"];
_mediumRig = ["MNP_Vest_ACU_1","MNP_Vest_ACU_1"]; 	// default for all infantry classes
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		_unit addItem _earplugs;
		_attachments = [_attach1,_silencer1,_scope3];
	};
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "ar":
	{
		...
		_attachments = [_attach1,_silencer1,_scope1];
	};

// LOADOUT: ASSISTANT AUTOMATIC RIFLEMAN
	case "aar":
	{
		_unit addmagazines [_riflemag,17];
...
// LOADOUT: RIFLEMAN (AT)
	case "rat":
	{
		...
		_unit addItem _epipen;
		_unit addItem _earplugs;
		_attachments = [_attach1,_scope3,_silencer1];
	};
