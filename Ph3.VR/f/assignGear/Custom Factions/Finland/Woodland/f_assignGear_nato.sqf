...
// ATTACHMENTS - PRIMARY
_attach1 = "BWA3_acc_LLM01_flash";	// IR Laser
...
_glflarewhite = "hlc_GRD_White";
_glflarered = "hlc_GRD_White";
_glflareyellow = "hlc_GRD_Red";
_glflaregreen = "hlc_GRD_green";
...
_baseUniform = ["MNP_CombatUniform_Fin_B","MNP_CombatUniform_Fin_A"];
_baseHelmet = ["MNP_Helmet_FIN_T","MNP_Helmet_FIN_T","MNP_Helmet_FIN_T","MNP_Helmet_FIN_T","MNP_Helmet_FIN_T","MNP_Helmet_FIN_T","MNP_Boonie_FIN"];
_baseGlasses = [];

// Armored vests
_lightRig = ["MNP_Vest_FIN_1"];
_mediumRig = ["MNP_Vest_FIN_1"]; 	// default for all infantry classes
