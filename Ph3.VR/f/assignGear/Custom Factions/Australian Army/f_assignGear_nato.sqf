// F3 - Folk Assign Gear Script - Australian Army
...
_scope1 = "CUP_optic_TrijiconRx01_black";	// Holosight
...
_rifle = "hlc_rifle_auga1_b";
_riflemag = "hlc_30Rnd_556x45_B_AUG";
_riflemag_tr = "hlc_30Rnd_556x45_T_AUG";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "hlc_rifle_auga2carb_b";
...
_glrifle = "hlc_rifle_auga3_GL_B";
_glriflemag = "hlc_30Rnd_556x45_B_AUG";
_glriflemag_tr = "hlc_30Rnd_556x45_T_AUG";
...
_baseUniform = ["MNP_CombatUniform_Australia","MNP_CombatUniform_Australia_S"];
_baseHelmet = ["MNP_Helmet_Australia","H_HelmetB_plain_mcamo"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_oli"];
_mediumRig = ["MNP_Vest_Australia_B","MNP_Vest_Australia"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_Australia"];
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_Australia"];
...
// Ghillie
_ghillieUniform = ["MNP_CombatUniform_Australia"];
_ghillieHelmet = ["MNP_Boonie_AUS"];
_ghillieRig = ["MNP_Vest_Australia_B"];
_ghillieGlasses = [];
