// F3 - Folk Assign Gear Script - 80s DPM
// Credits: Please see the F3 online manual (http://www.ferstaberinde.com/f3/en/)
// ====================================================================================

// DEFINE EQUIPMENT TABLES
// The blocks of code below identifies equipment for this AGM_Vector
//
// Defined loadouts:
//		co			- commander
...
_scope2 = "optic_Arco";			// MRCO Scope - 1x - 6x
...
_baseHelmet = ["MNP_Boonie_DPM","H_Beret_blk"];
_baseGlasses = [];
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_DPM"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["V_TacVest_oli"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_DPM_B"];
_crewHelmet = ["H_HelmetCrew_I"];
_crewRig = ["V_TacVest_oli"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["MNP_CombatUniform_DPM"];
...
// Handle clothes and helmets and such using the include file called next.
	...
	// uncomment to remove nvgoogles
						// add universal NVG for this AGM_Vector
...
// SETUP BACKPACKS
// Include the correct backpack file for the AGM_Vector
