...
_silencer1 = "CUP_muzzle_snds_L85";		// Primary Suppressor
...
_mediumRig = ["STKR_Osprey_R"]; 	// default for all infantry classes
_heavyRig = ["STKR_Osprey_R"];
...
_ghillieHelmet = ["STKR_MK7_ScrimB"];
