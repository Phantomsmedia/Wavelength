// F3 - Folk Assign Gear Script - British Army 80s DDPM
...
_scope1 = "hlc_optic_suit";					// Holosight
_scope2 = "hlc_optic_suit";					// MRCO Scope - 1x - 6x
_scope3 = "hlc_optic_suit";		// SOS Scope - 18x - 75x
...
_SNrifleMag = "hlc_20rnd_762x51_b_fal";
...
_baseUniform = ["MNP_CombatUniform_NPA_Alt","MNP_CombatUniform_NPA_Alt_B"];
_baseHelmet = ["MNP_Boonie_DDPM","H_Beret_blk"];
_baseGlasses = [];
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_NPA_Alt_B"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["V_TacVest_brn"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_NPA_Alt"];
_crewHelmet = ["H_HelmetCrew_I"];
_crewRig = ["V_TacVest_brn"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["MNP_CombatUniform_NPA_Alt_B"];
_ghillieHelmet = ["H_ShemagOpen_tan"];
_ghillieRig = ["V_Chestrig_khk"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["MNP_CombatUniform_NPA_Alt"];
_sfhelmet = ["MNP_Boonie_DDPM","H_Beret_blk"];
_sfRig = _mediumRig;
_sfGlasses = [];
