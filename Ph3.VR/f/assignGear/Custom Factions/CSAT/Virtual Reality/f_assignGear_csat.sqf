// F3 - Folk Assign Gear Script - CSAT Virtual Reality
...
_baseUniform = ["U_O_Protagonist_VR"];
...
// Pilot
_pilotUniform = ["U_O_Protagonist_VR"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["V_TacVest_blk"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_O_Protagonist_VR"];
_crewHelmet = ["H_HelmetCrew_O"];
_crewRig = ["V_TacVest_blk"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["U_O_Protagonist_VR"];
_ghillieHelmet = [];
