...
_bagmedium = "B_FieldPack_oucamo";			// carries 240, weighs 30
...
_mediumRig = ["V_HarnessO_gry"]; 	// default for all infantry classes
_heavyRig = ["V_HarnessO_gry"];
