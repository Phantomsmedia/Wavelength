// F3 - Folk Assign Gear Script - North Vietnamese Army
...
// Backpacks
_bagsmall = "V_Chestrig_khk";				// carries 120, weighs 20
_bagmedium = "V_Chestrig_khk";				// carries 240, weighs 30
...
_baseHelmet = ["MNP_Helmet_SOV_Steel","MNP_Helmet_SOV_Steel","MNP_MC_OD"];
_baseGlasses = [];
