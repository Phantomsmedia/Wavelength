// F3 - Folk Assign Gear Script - CDF
...
_mediumRig = ["LOP_V_CarrierLite_CDF","LOP_V_CarrierRig_CDF"]; 	// default for all infantry classes
...
_ghillieHelmet = ["LOP_H_PASGTHelmet_cover_CDF"];
_ghillieRig = ["LOP_V_CarrierLite_CDF"];
_ghillieGlasses = [];
