...
// Backpacks
_bagsmall = "rhsusf_assault_eagleaiii_ocp";		// small backpack
_bagmedium = "rhsusf_assault_eagleaiii_ocp";	// medium backpack
_baglarge =  "rhsusf_assault_eagleaiii_ocp"; 	// heavy backpack
