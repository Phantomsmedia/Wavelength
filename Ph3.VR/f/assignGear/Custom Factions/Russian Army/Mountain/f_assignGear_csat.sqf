// F3 - Folk ARPS Assign Gear Script - Russian Army - Mountain
...
_silencer0 = "rhs_acc_dtk"		// Rifle Muzzle
...
// Armored vests
_lightRig = ["rhs_6sh92"];
_mediumRig = ["rhs_6b23_ML_6sh92","rhs_6b23_ML_6sh92_radio"]; 	// default for all infantry classes
_heavyRig = ["rhs_6b13"];
...
// Pilot
_pilotUniform = ["rhs_uniform_mflora_patchless"];
...
// Ghillie
_ghillieUniform = ["rhs_uniform_mflora_patchless"];
_ghillieHelmet = ["rhs_Booniehat_flora"];
_ghillieRig = ["rhs_6b23_ML_6sh92_headset"];
_ghillieGlasses = [];
...
// LOADOUT: PLATOON LEADER
	case "pl":
	{
		...
		_attachments = [_attach1,_scope2,_silencer0];		
	};
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		_unit addItem _earplugs;
		_attachments = [_attach1,_silencer0];
	};
...
// LOADOUT: FIRE TEAM LEADER
	case "ftl":
	{
		...
		_unit addItem _epipen;
		_unit addItem _earplugs;
		_attachments = [_attach1,_scope1,_silencer0];
	};
