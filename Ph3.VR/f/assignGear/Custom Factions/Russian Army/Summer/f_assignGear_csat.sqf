// F3 - Folk Assign Gear Script - Summer
...
_baseHelmet = ["rhs_6b27m_digi","rhs_6b28","rhs_6b28_ess"];
_baseGlasses = [];
...
_heavyRig = ["rhs_6b23_digi_6sh92_vog"];
...
_ghillieRig = ["rhs_6b23_digi_6sh92_headset_mapcase"];
_ghillieGlasses = [];
