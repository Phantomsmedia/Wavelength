// F3 - Folk Assign Gear Script - MSV Summer
...
_baseUniform = ["rhs_uniform_msv_emr"];
_baseHelmet = ["rhs_6b27m_digi","rhs_6b27m_digi_bala"];
_baseGlasses = [];
...
// Ghillie
_ghillieUniform = ["rhs_uniform_msv_emr"];
_ghillieHelmet = ["rhs_Booniehat_digi"];	
_ghillieRig = ["rhs_6b23_digi_sniper"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhs_uniform_msv_emr"];
_sfhelmet = ["rhs_6b28"];
