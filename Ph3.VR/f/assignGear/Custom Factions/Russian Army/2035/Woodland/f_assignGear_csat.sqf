// F3 - Folk Assign Gear Script - Russian 2035 Woodland
...
_baseUniform = ["MNP_CombatUniform_Russia_Heavy"];
_baseHelmet = ["MNP_Helmet_Russia"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_blk"];
_mediumRig = ["MNP_Vest_RU_T","MNP_Vest_RU_T2"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_RU_T2"];
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_Russia_Heavy"];
_pilotHelmet = ["H_PilotHelmetHeli_B"];
_pilotRig = ["V_TacVest_blk"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_Russia_Heavy"];
_crewHelmet = ["H_HelmetCrew_B"];
_crewRig = ["V_TacVest_oli"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["MNP_CombatUniform_Russia_Heavy"];
_ghillieHelmet = [MNP_Boonie_RU_T];
_ghillieRig = ["MNP_Vest_RU_T"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["MNP_CombatUniform_RU_Med"];
_sfhelmet = ["MNP_Boonie_RU_T"];
_sfRig = _mediumRig;
_sfGlasses = [];
