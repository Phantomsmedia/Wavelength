// F3 - Folk ARPS Assign Gear Script - USMC - MARSOC (Suppressors)
...
_baseGlasses = ["rhs_googles_black","rhs_googles_clear"];

// Armored vests
_lightRig = ["V_TacVest_brn","V_TacVest_blk"];
...
_ghillieGlasses = ["rhs_googles_black","rhs_googles_clear"];
