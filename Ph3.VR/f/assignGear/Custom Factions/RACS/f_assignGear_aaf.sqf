// F3 - Folk Assign Gear Script - RACS
...
_baseHelmet = ["LOP_H_PASGTHelmet_cover_RACS","LOP_H_PASGTHelmet_TAN"];
_baseGlasses = [];
...
// Ghillie
_ghillieUniform = ["LOP_U_RACS_Fatigue_01"];
_ghillieHelmet = ["LOP_H_PASGTHelmet_cover_RACS","LOP_H_PASGTHelmet_TAN"];
