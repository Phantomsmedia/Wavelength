...
_baseHelmet = ["H_Bandanna_camo","H_ShemagOpen_tan","LOP_H_SSh68Helmet_OLV","LOP_H_PASGTHelmet_OLV"];
_baseGlasses = [];
...
_ghillieHelmet = ["H_Bandanna_camo","H_ShemagOpen_tan","LOP_H_SSh68Helmet_OLV","LOP_H_PASGTHelmet_OLV"];
