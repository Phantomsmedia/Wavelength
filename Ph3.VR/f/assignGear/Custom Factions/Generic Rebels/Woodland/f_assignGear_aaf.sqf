...
_baseUniform = ["MNP_CombatUniform_Militia_E","MNP_CombatUniform_Militia_F","MNP_CombatUniform_Militia_C","MNP_CombatUniform_Militia_A","MNP_CombatUniform_Militia_B"];
_baseHelmet = ["MNP_Boonie_TIG","H_Shemag_olive","H_ShemagOpen_khk","H_Cap_oli","H_Bandanna_camo"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_oli","V_TacVest_camo"];
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_Militia_E","MNP_CombatUniform_Militia_F","MNP_CombatUniform_Militia_C","MNP_CombatUniform_Militia_A","MNP_CombatUniform_Militia_B"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["V_TacVest_oli","V_TacVest_camo"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_Militia_E","MNP_CombatUniform_Militia_F","MNP_CombatUniform_Militia_C","MNP_CombatUniform_Militia_A","MNP_CombatUniform_Militia_B"];
_crewHelmet = ["rhs_tsh4"];
_crewRig = ["V_TacVest_oli","V_TacVest_camo"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["MNP_CombatUniform_Militia_E","MNP_CombatUniform_Militia_F","MNP_CombatUniform_Militia_C","MNP_CombatUniform_Militia_A","MNP_CombatUniform_Militia_B"];
_ghillieHelmet = ["MNP_Boonie_TIG","H_Shemag_olive","H_ShemagOpen_khk","H_Cap_oli","H_Bandanna_camo"];
