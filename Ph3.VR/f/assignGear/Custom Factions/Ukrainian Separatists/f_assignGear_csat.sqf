// F3 - Folk Assign Gear Script - Ukrainian Separatists
...
_baseUniform = ["LOP_U_US_Fatigue_01","LOP_U_US_Fatigue_02","LOP_U_US_Fatigue_01_slv","LOP_U_US_Fatigue_02_slv"];
_baseHelmet = ["rhs_6b27m_green","rhs_6b27m_green_ess","H_Bandanna_sgg","H_Booniehat_oli"];
_baseGlasses = [];
...
// Pilot
_pilotUniform = ["LOP_U_US_Fatigue_01","LOP_U_US_Fatigue_02"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["LOP_V_Chestrig_kamysh"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["LOP_U_US_Fatigue_01_slv","LOP_U_US_Fatigue_02_slv"];
_crewHelmet = ["rhs_tsh4","rhs_tsh4_bala","rhs_tsh4_ess","rhs_tsh4_ess_bala"];
_crewRig = ["LOP_V_Chestrig_kamysh"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["LOP_U_US_Fatigue_01","LOP_U_US_Fatigue_02","LOP_U_US_Fatigue_01_slv","LOP_U_US_Fatigue_02_slv"];
