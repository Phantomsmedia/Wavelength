// F3 - Folk ARPS Assign Gear Script - Ukrainian Separatists
...
_baseHelmet = ["H_Bandanna_sgg","H_Cap_blk","H_Booniehat_oli","rhs_6b27m_green","rhs_6b27m_green_ess"];
_baseGlasses = [];
...
// Pilot
_pilotUniform = ["LOP_U_US_Fatigue_01","LOP_U_US_Fatigue_02","LOP_U_US_Fatigue_01_slv","LOP_U_US_Fatigue_02_slv"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["V_TacVest_oli"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["LOP_U_US_Fatigue_01","LOP_U_US_Fatigue_02","LOP_U_US_Fatigue_01_slv","LOP_U_US_Fatigue_02_slv"];
