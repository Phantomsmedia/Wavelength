...
_baseUniform = ["LOP_U_ChDKZ_Fatigue_02","LOP_U_ChDKZ_Fatigue_03","LOP_U_ChDKZ_Fatigue_04"];
_baseHelmet = ["H_Bandanna_camo","H_Booniehat_oli","rds_Woodlander_cap1","rds_Woodlander_cap4","LOP_H_SSh68Helmet_OLV"];
_baseGlasses = [];
...
// Pilot
_pilotUniform = ["LOP_U_ChDKZ_Fatigue_02","LOP_U_ChDKZ_Fatigue_03","LOP_U_ChDKZ_Fatigue_04"];
_pilotHelmet = ["rhs_gssh18"];
_pilotRig = ["V_TacVest_oli"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["LOP_U_ChDKZ_Fatigue_02","LOP_U_ChDKZ_Fatigue_03","LOP_U_ChDKZ_Fatigue_04"];
_crewHelmet = ["rhs_tsh4","rhs_tsh4_ess"];
_crewRig = ["V_TacVest_oli"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["LOP_U_ChDKZ_Fatigue_02","LOP_U_ChDKZ_Fatigue_03","LOP_U_ChDKZ_Fatigue_04"];
