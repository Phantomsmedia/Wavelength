...
_ARmag_tr = "hlc_75Rnd_762x39_t_rpk";
...
// Spec Op
_sfuniform = ["U_CAF_AG_EEUR_FATIGUES_01a"];
_sfhelmet = ["H_caf_ag_fur","H_caf_ag_boonie_02"];
_sfRig = ["V_HarnessO_brn"];
_sfGlasses = ["G_Bandanna_khk","G_Bandanna_oli,"G_Balaclava_blk"];
