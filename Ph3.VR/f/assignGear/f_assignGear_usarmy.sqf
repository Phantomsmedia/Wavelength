...
_baseUniform = ["AV_CombatUniform1_UCP","AV_CombatUniform1_UCP_shortsleeve"];
_baseHelmet = ["AV_ACH1_UCP","AV_ACH3_UCP","AV_ACH2_UCP"];
_baseGlasses = [];
...
// Ghillie
_ghillieUniform = ["AV_GhillieUniform2_UCP"];
_ghillieHelmet = [];
_ghillieRig = ["AV_PlateCarrier2_UCP"];
_ghillieGlasses = [];
