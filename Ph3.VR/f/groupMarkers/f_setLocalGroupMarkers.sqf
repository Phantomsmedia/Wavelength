...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_XO", 0, "XO", "ColorYellow"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["GrpCSAT_XO", 0, "XO", "ColorYellow"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		...
		["GrpAAF_XO", 0, "XO", "ColorYellow"] spawn f_fnc_localGroupMarker;
