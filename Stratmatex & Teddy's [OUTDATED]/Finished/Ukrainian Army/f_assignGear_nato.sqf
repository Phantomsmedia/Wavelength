...
_baseUniform = ["MNP_CombatUniform_Ukrainian","MNP_CombatUniform_Rebel_A"];
_baseHelmet = ["MNP_Helmet_PAGST_UKR"];
_baseGlasses = [];

// Vests
_lightRig = ["MNP_Vest_UKR_A"];
_mediumRig = ["MNP_Vest_UKR_A"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_UKR_A"];
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_Ukrainian"];
_pilotHelmet = ["rhs_gssh18"];
_pilotRig = ["V_TacVest_oli"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_Ukrainian"];
