...
_scope1 = "CUP_optic_MRad";					// Short Range
...
// Vests
_lightRig = ["MNP_Vest_ChinaH_T"];
_mediumRig = ["MNP_Vest_ChinaH_T"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_ChinaH_T"];
...
_ghillieHelmet = ["MNP_Helmet_PAGST_CN"];
