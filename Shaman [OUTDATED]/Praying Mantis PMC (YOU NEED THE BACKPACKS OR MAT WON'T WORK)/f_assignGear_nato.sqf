...
_scope1 = "CUP_optic_CompM2_Desert";	// Short Range
_scope2 = "CUP_optic_CompM2_Desert";			// Medium Range
_scope3 = "rhsusf_acc_ACOG";		// Medium - Long Range
...
_glrifle = "CUP_arifle_Mk17_CQC_EGLM";
...
// Automatic Rifleman
_AR = "CUP_lmg_M60A4";
_ARmag = "CUP_100Rnd_TE4_LRT4_White_Tracer_762x51_Belt_M";
...
_DMriflemag = "rhsusf_20Rnd_762x51_m993_Mag";
...
_baseUniform = ["TRYK_U_B_BLKTAN"];
_baseHelmet = ["TRYK_ESS_CAP","TRYK_H_DELTAHELM_NV","TRYK_H_PASGT_BLK"];
_baseGlasses = [];

// Vests
_lightRig = ["TRYK_V_ArmorVest_khk2"];
_mediumRig = ["TRYK_V_ArmorVest_khk2"]; 	// default for all infantry classes
