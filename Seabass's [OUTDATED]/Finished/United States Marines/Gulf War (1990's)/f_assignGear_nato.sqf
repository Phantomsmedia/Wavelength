// F3 - Folk ARPS Assign Gear Script - US Marine Corps (Gulf War)
...
_scope3 = "";		// Medium - Long Range
_scope4 = "CUP_optic_LeupoldMk4_10x40_LRT_Desert";	// Long Range
...
_glsmokewhite = "rhs_mag_M585_white";
_glsmokegreen = "rhs_mag_m661_green";
_glsmokered = "rhs_mag_m662_red";

// Flares for FTLs, Squad Leaders, etc
_glflarewhite = "rhs_mag_m714_White";
_glflarered = "rhs_mag_m713_Red";
_glflareyellow = "rhs_mag_m716_yellow";
_glflaregreen = "rhs_mag_m715_Green";
...
// Backpacks
_bagsmall = "MNP_B_WD_CA";				// small
_bagmedium = "MNP_B_WD_CA";	// medium
_baglarge =  "MNP_B_WD_CA"; 					// large
...
_baseHelmet = ["MNP_Helmet_6Co"];
_baseGlasses = ["TRYK_US_ESS_Glasses"];

// Vests
_lightRig = ["MNP_Vest_M81b"];
_mediumRig = ["MNP_Vest_M81b"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_M81b"];
...
_pilotRig = ["MNP_Vest_M81b"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_6CO"];
_crewHelmet = ["MNP_Helmet_6Co"];
_crewRig = ["MNP_Vest_M81b"];
_crewGlasses = ["TRYK_US_ESS_Glasses"];

// Ghillie
_ghillieUniform = ["MNP_CombatUniform_6CO"];
