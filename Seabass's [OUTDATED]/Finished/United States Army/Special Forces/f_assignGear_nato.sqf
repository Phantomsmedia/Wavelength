// F3 - Folk ARPS Assign Gear Script - US Army Special Forces
...
_silencer1 = "rhsusf_acc_rotex5_grey";	// Primary
_silencer2 = "muzzle_snds_M";			// Diver

_scope1 = "optic_Holosight";			// Short Range
_scope2 = "optic_Holosight";			// Medium Range
...
_bagmedium = "B_AssaultPack_mcamo";	// medium
_baglarge =  "B_Kitbag_mcamo"; 					// large
...
_baseUniform = ["TRYK_U_B_NATO_OCP_CombatUniform"];
_baseHelmet = ["rhsusf_opscore_03_ocp"];
_baseGlasses = [];

// Vests
_lightRig = ["MNP_Vest_Scorpion_2"];
_mediumRig = ["MNP_Vest_Scorpion_2"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_Scorpion_2"];
...
// Ghillie
_ghillieUniform = ["TRYK_U_B_NATO_OCP_CombatUniform"];
_ghillieHelmet = ["rhsusf_opscore_03_ocp"];
_ghillieRig = ["MNP_Vest_Scorpion_2"];
_ghillieGlasses = [];
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "ar":
	{
		...
		["ar"] call _backpack;
		_attachments = [_attach1,_bipod1,_scope2];
	};
